...
try:
    ...
    for module in [
        ...
        EXT_MODULES += [
            Extension(module, ['{}.py'.format(module.replace('.', os.sep))]),
        ]
except ImportError:
    pass
...
long_description = u'\n\n'.join([read('README.rst'), read('doc/CHANGES.rst')])
...
setup(
    ...
    author=
    'Giovanni Bajo, Hartmut Goebel, David Vierra, David Cortesi, Martin Zibricky',
