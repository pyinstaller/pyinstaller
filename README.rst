...
- Official debugging guide: https://pyinstaller.org/en/v5.11.0/when-things-go-wrong.html
...
.. _`manual`: https://pyinstaller.org/en/v5.11.0/
.. _`Changelog`: https://pyinstaller.org/en/v5.11.0/CHANGES.html
