...
image_characteristics = [
    ('IMAGE_FILE_RELOCS_STRIPPED',
     0x0001), ('IMAGE_FILE_EXECUTABLE_IMAGE',
               0x0002), ('IMAGE_FILE_LINE_NUMS_STRIPPED',
                         0x0004), ('IMAGE_FILE_LOCAL_SYMS_STRIPPED', 0x0008),
    ('IMAGE_FILE_AGGRESIVE_WS_TRIM',
     0x0010), ('IMAGE_FILE_LARGE_ADDRESS_AWARE',
               0x0020), ('IMAGE_FILE_16BIT_MACHINE',
                         0x0040), ('IMAGE_FILE_BYTES_REVERSED_LO', 0x0080),
    ('IMAGE_FILE_32BIT_MACHINE',
     0x0100), ('IMAGE_FILE_DEBUG_STRIPPED',
               0x0200), ('IMAGE_FILE_REMOVABLE_RUN_FROM_SWAP',
                         0x0400), ('IMAGE_FILE_NET_RUN_FROM_SWAP',
                                   0x0800), ('IMAGE_FILE_SYSTEM', 0x1000),
    ('IMAGE_FILE_DLL', 0x2000), ('IMAGE_FILE_UP_SYSTEM_ONLY',
...
SECTION_CHARACTERISTICS = dict([(e[1], e[0]) for e in section_characteristics]
                               + section_characteristics)

debug_types = [('IMAGE_DEBUG_TYPE_UNKNOWN', 0), ('IMAGE_DEBUG_TYPE_COFF', 1),
               ('IMAGE_DEBUG_TYPE_CODEVIEW',
                2), ('IMAGE_DEBUG_TYPE_FPO', 3), ('IMAGE_DEBUG_TYPE_MISC', 4),
               ('IMAGE_DEBUG_TYPE_EXCEPTION',
                5), ('IMAGE_DEBUG_TYPE_FIXUP',
                     6), ('IMAGE_DEBUG_TYPE_OMAP_TO_SRC',
                          7), ('IMAGE_DEBUG_TYPE_OMAP_FROM_SRC',
                               8), ('IMAGE_DEBUG_TYPE_BORLAND',
                                    9), ('IMAGE_DEBUG_TYPE_RESERVED10',
                                         10), ('IMAGE_DEBUG_TYPE_CLSID', 11)]

DEBUG_TYPE = dict([(e[1], e[0]) for e in debug_types] + debug_types)

subsystem_types = [('IMAGE_SUBSYSTEM_UNKNOWN',
                    0), ('IMAGE_SUBSYSTEM_NATIVE',
                         1), ('IMAGE_SUBSYSTEM_WINDOWS_GUI',
                              2), ('IMAGE_SUBSYSTEM_WINDOWS_CUI',
                                   3), ('IMAGE_SUBSYSTEM_OS2_CUI',
                                        5), ('IMAGE_SUBSYSTEM_POSIX_CUI', 7),
                   ('IMAGE_SUBSYSTEM_NATIVE_WINDOWS',
                    8), ('IMAGE_SUBSYSTEM_WINDOWS_CE_GUI',
                         9), ('IMAGE_SUBSYSTEM_EFI_APPLICATION',
                              10), ('IMAGE_SUBSYSTEM_EFI_BOOT_SERVICE_DRIVER',
                                    11), ('IMAGE_SUBSYSTEM_EFI_RUNTIME_DRIVER',
                                          12), ('IMAGE_SUBSYSTEM_EFI_ROM', 13),
                   ('IMAGE_SUBSYSTEM_XBOX',
                    14), ('IMAGE_SUBSYSTEM_WINDOWS_BOOT_APPLICATION', 16)]
...
relocation_types = [('IMAGE_REL_BASED_ABSOLUTE',
                     0), ('IMAGE_REL_BASED_HIGH',
                          1), ('IMAGE_REL_BASED_LOW',
                               2), ('IMAGE_REL_BASED_HIGHLOW',
                                    3), ('IMAGE_REL_BASED_HIGHADJ', 4),
                    ('IMAGE_REL_BASED_MIPS_JMPADDR',
                     5), ('IMAGE_REL_BASED_SECTION',
                          6), ('IMAGE_REL_BASED_REL',
                               7), ('IMAGE_REL_BASED_MIPS_JMPADDR16',
                                    9), ('IMAGE_REL_BASED_IA64_IMM64', 9),
                    ('IMAGE_REL_BASED_DIR64', 10), ('IMAGE_REL_BASED_HIGH3ADJ',
                                                    11)]
...
resource_type = [('RT_CURSOR', 1), ('RT_BITMAP', 2), ('RT_ICON', 3),
                 ('RT_MENU', 4), ('RT_DIALOG', 5), ('RT_STRING',
                                                    6), ('RT_FONTDIR', 7),
                 ('RT_FONT', 8), ('RT_ACCELERATOR',
                                  9), ('RT_RCDATA',
                                       10), ('RT_MESSAGETABLE',
                                             11), ('RT_GROUP_CURSOR',
                                                   12), ('RT_GROUP_ICON', 14),
                 ('RT_VERSION', 16), ('RT_DLGINCLUDE',
                                      17), ('RT_PLUGPLAY', 19), ('RT_VXD', 20),
                 ('RT_ANICURSOR', 21), ('RT_ANIICON',
                                        22), ('RT_HTML', 23), ('RT_MANIFEST',
                                                               24)]

RESOURCE_TYPE = dict([(e[1], e[0]) for e in resource_type] + resource_type)

# Language definitions
lang = [('LANG_NEUTRAL', 0x00), ('LANG_INVARIANT',
                                 0x7f), ('LANG_AFRIKAANS',
                                         0x36), ('LANG_ALBANIAN',
                                                 0x1c), ('LANG_ARABIC', 0x01),
        ('LANG_ARMENIAN', 0x2b), ('LANG_ASSAMESE', 0x4d), ('LANG_AZERI', 0x2c),
        ('LANG_BASQUE', 0x2d), ('LANG_BELARUSIAN',
                                0x23), ('LANG_BENGALI',
                                        0x45), ('LANG_BULGARIAN',
                                                0x02), ('LANG_CATALAN', 0x03),
        ('LANG_CHINESE', 0x04), ('LANG_CROATIAN',
                                 0x1a), ('LANG_CZECH',
                                         0x05), ('LANG_DANISH',
                                                 0x06), ('LANG_DIVEHI', 0x65),
        ('LANG_DUTCH',
         0x13), ('LANG_ENGLISH',
                 0x09), ('LANG_ESTONIAN',
                         0x25), ('LANG_FAEROESE',
...
sublang = [
    ...
    ('SUBLANG_PORTUGUESE_BRAZILIAN',
     0x01), ('SUBLANG_SERBIAN_LATIN',
             0x02), ('SUBLANG_SERBIAN_CYRILLIC',
                     0x03), ('SUBLANG_SPANISH',
                             0x01), ('SUBLANG_SPANISH_MEXICAN',
                                     0x02), ('SUBLANG_SPANISH_MODERN', 0x03),
             ...
             0x05), ('SUBLANG_SPANISH_PANAMA',
                     0x06), ('SUBLANG_SPANISH_DOMINICAN_REPUBLIC',
                             0x07), ('SUBLANG_SPANISH_VENEZUELA',
                                     0x08), ('SUBLANG_SPANISH_COLOMBIA', 0x09),
    ...
    ('SUBLANG_URDU_INDIA',
     0x02), ('SUBLANG_UZBEK_LATIN',
             0x01), ('SUBLANG_UZBEK_CYRILLIC',
                     0x02), ('SUBLANG_DUTCH_SURINAM',
                             0x03), ('SUBLANG_ROMANIAN',
                                     0x01), ('SUBLANG_ROMANIAN_MOLDAVIA',
                                             0x02), ('SUBLANG_RUSSIAN', 0x01),
    ('SUBLANG_RUSSIAN_MOLDAVIA',
     0x02), ('SUBLANG_CROATIAN',
             0x01), ('SUBLANG_LITHUANIAN_CLASSIC',
                     0x02), ('SUBLANG_GAELIC',
                             0x01), ('SUBLANG_GAELIC_SCOTTISH',
                                     0x02), ('SUBLANG_GAELIC_MANX', 0x03)
]
...
if 'lowercase' not in string.__dict__:  # Python 3.x
    ...
    allowed_filename = bytes(string.lowercase + string.uppercase +
                             string.digits + b"!#$%&'()-@^_`{}~+,.;=[]" +
                             bytes(range(128, 256)))
...
class PE(object):
                        ...
                        for st_entry in entry.StringTable:
                            for key, entry in list(st_entry.entries.items()):
                                ...
                                if len(entry) > lengths[1]:
                                    l = entry.decode('unicode-escape').encode(
                                        'utf-16le')
                                    file_data[
                                        offsets[1]:offsets[1] +
                                        lengths[1] * 2] = l[:lengths[1] * 2]
                                else:
                                    encoded_data = entry.decode(
                                        'unicode-escape').encode('utf-16le')
                                    file_data[offsets[1]:offsets[1] + len(
    ...
    def parse_sections(self, offset):
        ...
        for i in range(self.FILE_HEADER.NumberOfSections):
            ...
            section_data = self.__data__[section_offset:
                                         section_offset + section.sizeof()]
        ...
        while True:
            ...
            for idx in range(
                ...
                if name_str:
                    invalid_chars = [
                        c for c in name_str
                        if (chr(c) if isinstance(c, int) else c
    ...
    def parse_relocations(self, data_rva, rva, size):
        ...
        try:
            ...
            self.__warnings.append('Bad RVA in relocation data: 0x%x' %
                                   (data_rva))
            return []
    ...
    def parse_debug_directory(self, rva, size):
        ...
        for idx in range(old_div(size, dbg_size)):
            ...
            if dbg.Type == 1:
                ...
                dbg_type_data = self.__data__[dbg_type_offset:
                                              dbg_type_offset + dbg_type_size]
    ...
    def parse_version_information(self, version_struct):
        ...
        raw_data = self.__data__[start_offset:
                                 start_offset + version_struct.Size]
                    ...
                    while True:
                        ...
                        while varword_offset < orig_varword_offset + var_struct.ValueLength:
                            ...
                            if isinstance(word1, int) and isinstance(
                                    word2, int):
                                var_struct.entry = {
                                    var_string: '0x%04x 0x%04x' % (word1,
                                                                   word2)
                                }
    ...
    def parse_export_directory(self, rva, size, forwarded_only=False):
        ...
        if not section:
            ...
            safety_boundary = section.VirtualAddress + len(
                section.get_data()) - export_dir.AddressOfNames

        for i in range(
                min(export_dir.NumberOfNames, old_div(safety_boundary, 4))):
        ...
        if not section:
            ...
            safety_boundary = section.VirtualAddress + len(
                section.get_data()) - export_dir.AddressOfFunctions

        safety_boundary = section.VirtualAddress + len(
            section.get_data()) - export_dir.AddressOfFunctions

        for idx in range(
                min(export_dir.NumberOfFunctions, old_div(safety_boundary,
                                                          4))):
    ...
    def get_string_at_rva(self, rva):
        ...
        return self.get_string_from_data(0,
                                         s.get_data(
                                             rva, length=MAX_STRING_LENGTH))
    ...
    def dump_info(self, dump=None):
        ...
        for section in self.sections:
            ...
            if md5 is not None:
                dump.add_line(
                    'MD5     hash: {0}'.format(section.get_hash_md5()))
            if sha1 is not None:
                ...
                for entry in self.FileInfo:
                    ...
                    if hasattr(entry, 'StringTable'):
                        for st_entry in entry.StringTable:
                            ...
                            dump.add_line('  LangID: {0}'.format(
                                st_entry.LangID.decode('ascii')))
                            dump.add_newline()
                            for str_entry in sorted(
                                    list(st_entry.entries.items())):
                                dump.add_line('    {0}: {1}'.format(
                                    str(str_entry[0], 'utf-8',
                                        'backslashreplace'),
                                    str(str_entry[1], 'utf-8',
                                        'backslashreplace')))
                        dump.add_newline()
        ...
        if hasattr(self, 'DIRECTORY_ENTRY_BOUND_IMPORT'):
            ...
            for bound_imp_desc in self.DIRECTORY_ENTRY_BOUND_IMPORT:
                ...
                for bound_imp_ref in bound_imp_desc.entries:
                    ...
                    dump.add_line('DLL: {0}'.format(
                        bound_imp_ref.name.decode('utf-8',
                                                  'backslashreplace')), 4)
                    dump.add_newline()
        ...
        if hasattr(self, 'DIRECTORY_ENTRY_RESOURCE'):
            ...
            for resource_type in self.DIRECTORY_ENTRY_RESOURCE.entries:
                ...
                if resource_type.name is not None:
                    ...
                    dump.add_line('Name: [{0}]'.format(name.decode('ascii')),
                                  2)
                else:
                    dump.add_line('Id: [0x{0:X}] ({1})'.format(
                        resource_type.struct.Id,
                        RESOURCE_TYPE.get(resource_type.struct.Id, '-')), 2)
                ...
                if hasattr(resource_type, 'directory'):
                    ...
                    for resource_id in resource_type.directory.entries:
                        ...
                        if resource_id.name is not None:
                            ...
                            dump.add_line(
                                'Name: [{0}]'.format(name.decode('ascii')), 6)
                        else:
                            dump.add_line(
            ...
            for base_reloc in self.DIRECTORY_ENTRY_BASERELOC:
                ...
                for reloc in base_reloc.entries:
                    try:
                        ...
                        dump.add_line('0x%08X 0x%x(Unknown)' % (reloc.rva,
                                                                reloc.type), 4)
                dump.add_newline()
                    ...
                    if hasattr(entry, 'StringTable'):
                        ...
                        for var_entry in entry.Var:
                            ...
                            if hasattr(var_entry, 'entry'):
                                ...
                                var_dict[list(var_entry.entry.keys())[
                                    0]] = list(var_entry.entry.values())[0]
                        ...
                        if hasattr(resource_id, 'directory'):
                            ...
                            if hasattr(resource_id.directory, 'strings'
                                ...
                                for idx, res_string in list(
                                        resource_id.directory.strings.items()):
                                    resource_id_list.append(
                                        convert_to_printable(res_string))
            ...
            while entry_idx < len(reloc.entries):
                ...
                if entry.type == RELOCATION_TYPE['IMAGE_REL_BASED_ABSOLUTE']:
                    ...
                    self.set_word_at_rva(
                        entry.rva, (self.get_word_at_rva(entry.rva) +
                    ...
                    self.set_word_at_rva(
                        ...
                        ((self.get_word_at_rva(entry.rva) << 16) +
                         next_entry.rva + relocation_difference & 0xffff0000)
                        >> 16)
    ...
    def generate_checksum(self):
        ...
        for i in range(old_div(data_len, 4)):
            ...
            if i + 1 == (old_div(data_len, 4)) and remainder:
                dword = struct.unpack('I', self.__data__[i * 4:] +
                                      ('\0' * (4 - remainder)))[0]
            else:
