...
def __add_options(parser):
    ...
    g.add_argument('--osx-bundle-identifier', dest='bundle_identifier',
                   help='Mac OS X .app bundle identifier is used as the default unique program '
                        ...
                        "(default: first script's basename)")
    g.add_argument('--osx-info-plist', dest='info_plist_path',
...
def main(scripts, name=None, onefile=None,
         ...
         datas=None, binaries=None, icon_file=None,
         manifest=None, resources=None,
         bundle_identifier=None, info_plist_path=None,
    ...
    if info_plist_path:
        ...
        if hasattr(plistlib, 'readPlist'):
            ...
            # python >= 3.4
            with open_file(info_plist_path, 'rb') as info_plist_file:
    ...
    d = {
        ...
        # Property list for Mac OS X application
