...
from PyInstaller.building.templates import (bundleexetmplt, bundletmplt,
                                            cipher_absent_template,
                                            cipher_init_template, onedirtmplt,
...
def add_data_or_binary(string):
    try:
        ...
        raise argparse.ArgumentError(
            "Wrong syntax, should be SRC{}DEST".format(add_command_sep)) from e
...
class Path:
    ...
    def __repr__(self):
        if self.filename_suffix is None:
            self.variable_prefix, self.filename_suffix = make_variable_path(
                self.path)
        if self.variable_prefix is None:
            return repr(self.path)
        return "os.path.join(" + self.variable_prefix + "," + repr(
...
def __add_options(parser):
    ...
    g.add_argument(
        ...
        'This option can be used multiple times.')
    g.add_argument('--collect-submodules',
                   action="append",
                   default=[],
                   metavar="MODULENAME",
    ...
    g.add_argument('--collect-binaries',
                   action="append",
                   default=[],
                   metavar="MODULENAME",
    ...
    g.add_argument('--copy-metadata',
                   ...
                   'This option can be used multiple times.')
    g.add_argument('--recursive-copy-metadata',
                   action="append",
                   default=[],
                   metavar="PACKAGENAME",
    ...
    g.add_argument("--additional-hooks-dir",
                   action="append",
                   dest="hookspath",
                   default=[],
                   help="An additional path to search for hooks. "
                   "This option can be used multiple times.")
    g.add_argument('--runtime-hook',
                   action='append',
                   dest='runtime_hooks',
                   default=[],
    ...
    g.add_argument("--win-private-assemblies",
    ...
    g.add_argument('--target-architecture',
                   '--target-arch',
                   dest='target_arch',
                   metavar='ARCH',
                   default=None,
    ...
    g.add_argument('--codesign-identity',
    ...
    g.add_argument('--osx-entitlements-file',
    ...
    g.add_argument("--runtime-tmpdir",
                   ...
                   "are doing.")
    g.add_argument("--bootloader-ignore-signals",
                   action="store_true",
                   default=False,
