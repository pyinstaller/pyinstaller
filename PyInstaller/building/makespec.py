...
def __add_options(parser):
    ...
    g.add_argument(
        ...
        "by %s, or use this option multiple times" % repr(os.pathsep))
    g.add_argument(
        '--hidden-import',
        '--hiddenimport',
        action='append',
    ...
    g.add_argument(
        ...
        'This option can be used multiple times.')
    g.add_argument(
        '--key', dest='key', help='The key used to encrypt Python bytecode.')
    ...
    g.add_argument(
        ...
        help=
        'Mac OS X .app bundle identifier is used as the default unique program '
    ...
    if key:
        ...
        try:
            ...
            is_version_acceptable = LooseVersion(
                Crypto.__version__) >= LooseVersion('2.4')
