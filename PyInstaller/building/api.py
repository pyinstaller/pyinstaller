...
class EXE(Target):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.lib_subdir = kwargs.get('lib_subdir', None)
        ...
        if self.lib_subdir is not None:
            self.toc.append(("pyi-lib-subdir " + self.lib_subdir, "", "OPTION"))
...
class COLLECT(Target):
    ...
    def __init__(self, *args, **kws):
        ...
        self.lib_subdir = kws.get("lib_subdir", None)
        self.console = True
