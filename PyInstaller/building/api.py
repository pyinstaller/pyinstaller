...
class PKG(Target):
    ...
    to include various read-only data in a sigle-file deployment.
    """
    typ = 'PKG'
    xformdict = {
        'PYMODULE': 'm',
...
class EXE(Target):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs
            ...
            debug
                Setting to True gives you progress mesages from the executable (for console=False there will be annoying
                MessageBoxes on Windows).
            name
    ...
    def _bootloader_file(self, exe, extension=None):
        ...
        """
        # Having console/windowed bootolader makes sense only on Windows and Mac OS.
    ...
    def assemble(self):
        ...
        if is_win:
            ...
            # We need to close the file, otherwise copying resources fails with "the file [...] is being used by
            # another process"
            os.close(fd)
            ...
            for res in self.resources:
                ...
                try:
                    winresource.UpdateResourcesFromResFile(
                        tmpnm, resfile, [restype or "*"], [resname or "*"], [reslang or "*"]
                    )
        ...
        # NOTE: Do not look up for bootloader file in the cache because it might get corrupted by UPX when UPX is
        #       available. See #1863 for details.
