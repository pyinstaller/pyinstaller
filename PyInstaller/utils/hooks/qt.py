...
_qt5_dynamic_dependencies_dict = {
    ...
    # for linux
    "qt5gui": (
        ".QtGui", "qtbase", "accessible", "iconengines", "imageformats", "platforms", "platforminputcontexts",
        "platformthemes", "styles", "xcbglintegrations", "egldeviceintegrations"
    ),  # noqa
    "qt5help": (
        ".QtHelp",
        "qt_help",
        ...
        datas += [
            ...
            (
                os.path.join(qt_library_info.location['TranslationsPath'],
                             locales), os.path.join(rel_data_path, 'translations', locales)
            ),
            ...
            (
                os.path.join(qt_library_info.location['LibraryExecutablesPath'], 'QtWebEngineProcess*'),
                os.path.join(
                    rel_data_path,
                    os.path.relpath(
                        qt_library_info.location['LibraryExecutablesPath'], qt_library_info.location['PrefixPath']
                    )
                )
            )
        ]
