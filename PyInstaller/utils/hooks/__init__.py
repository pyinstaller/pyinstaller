...
def is_package(module_name):
    ...
    try:
        ...
        if loader:
            ...
            try:
                # Even though we have a loader at this point, the import can
                # still fail in some cases. One such case is
                # importlib._bootstrap which cannot be imported directly.
