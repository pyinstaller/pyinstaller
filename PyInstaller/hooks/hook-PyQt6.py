...
from PyInstaller.utils.hooks.qt import pyqt6_library_info, get_qt_binaries
...
if pyqt6_library_info.version is not None:
    ...
    datas = [x for x in
             collect_system_data_files(pyqt6_library_info.location['PrefixPath'],
                                       os.path.join('PyQt6', 'Qt'))
