...
from PyInstaller.compat import modname_tkinter, is_py2
...
excludedimports = [modname_tkinter, 'PySide', 'PyQt4', 'PyQt5']
# Python 2 contains 'FixTk'.
if is_py2:
    excludedimports.append('FixTk')
