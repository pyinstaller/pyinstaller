...
from PyInstaller.utils.hooks.qt import pyside6_library_info, add_qt5_dependencies
...
if pyside6_library_info.version:
    ...
    qmldir = pyside6_library_info.location['Qml2ImportsPath']
    # Not all PySide6 installs have QML files. In this case, ``qmldir`` is empty. In
