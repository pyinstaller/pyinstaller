...
def getsitepackages(prefixes=None):
    ...
    For each directory present in prefixes - or site.PREFIXES if prefixes is
    None,this function will find its `site-packages` subdirectory depending on
    the system environment, and will return a list of full paths.
    """
    sitepackages = []
    seen = set()
