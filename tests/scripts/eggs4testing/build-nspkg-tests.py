...
make_package(
    'nspkg1-bbb', ['nspkg1', 'nspkg1.bbb'], ['nspkg1/bbb/zzz/__init__.py'],
    zip_safe=True)
...
make_package(
    'nspkg2-bbb', ['nspkg2', 'nspkg2.bbb'], ['nspkg2/bbb/zzz/__init__.py'],
    zip_safe=True)
...
make_package(
    'nspkg3-aaa', ['nspkg3'], ['nspkg3/aaa/__init__.py'],
    declare_namespace_template=pkgutil_extend_path_template)
make_package(
    ...
    declare_namespace_template=pkgutil_extend_path_template)
make_package(
    'nspkg3-ccc', ['nspkg3'], ['nspkg3/ccc.py'],
    declare_namespace_template=pkgutil_extend_path_template)
make_package(
    'nspkg3-empty', ['nspkg3'], [],
    zip_safe=True,
