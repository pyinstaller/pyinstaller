...
if __name__ == "__main__":
    print "######## Checking the result of --onefile Makespec option"

    if not os.path.isfile(TEST_FILE):
        raise SystemExit("Test file %s missing" % TEST_FILE)
    res = os.system("%s %s" % (os.path.join(HOME, "Makespec.py --onefile"), TEST_FILE))
    ...
    print "######## --onefile option test ends with success"