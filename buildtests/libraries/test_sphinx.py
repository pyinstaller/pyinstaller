...
import sphinx, sys
# See http://sphinx.pocoo.org/invocation.html#invocation for more details of the options below.
# Also, note that this is run in the dist/test_sphihnx direcotry, but uses conf.py and index.rst from this directory, so the command-line options uses '../..' to refer to these files.
