...
htmlhelp_basename = 'SphinxPyInstallertestdoc'
...
latex_documents = [
  ('index', 'SphinxPyInstallertest.tex', u'Sphinx PyInstaller test Documentation',
...
man_pages = [
    ('index', 'sphinxpyinstallertest', u'Sphinx PyInstaller test Documentation',
     [u'Bryan A. Jones'], 1)
]
...
texinfo_documents = [
  ('index', 'SphinxPyInstallertest', u'Sphinx PyInstaller test Documentation',
   u'Bryan A. Jones', 'SphinxPyInstallertest', 'One line description of project.',
   'Miscellaneous'),
]
