...
for (contents, path) in [
    ...
    (parser_to_rst(generate_parser(), section_references=False, option_directive=False),
     "man/_pyinstaller-options.tmp"),
    (parser_to_rst(makespec.generate_parser(), section_references=False, option_directive=False),
